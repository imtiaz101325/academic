...
public class Ques3_1_2
{
    public static void main (String[] args) 
    {
        ...
        int num = k.nextInt();//fist establish how many numbers to compute
        int product = 1;//this is where the numbers will be multiplied 
        //iteratively
        
        for(int i=1; i<=num; i++)//iterates n times
        {
            out.print("Enter next number: ");
            product *= k.nextInt();//multipying each number to p
        }
        
        double guess = product*1.0/num;//let's guess the nth root of p is this
        ...
        out.println("The estimated geometric mean is "+guess);//print the result
