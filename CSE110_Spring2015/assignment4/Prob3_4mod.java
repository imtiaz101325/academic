...
//Modified version of the sieve of eratosthenes

import static java.lang.System.*;
import java.util.*;

public class Prob3_4mod
{
    public static int eratosthenes(int n)
    {
        ...
        */
        ...
        boolean prime;//says if current x is prime
    ...
    public static void main(String[] args) 
    {
        ...
        int prime = eratosthenes(k.nextInt());

        if(prime!=1)
            out.println(prime+" is a prime.");
        else
            out.println(prime+" is not a prime.");
    }
}
