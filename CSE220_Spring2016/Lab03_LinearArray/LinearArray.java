public class LinearArray{
  ...
  public static int [] shiftLeft(int [] source, int k){
    ...
    for(int i=source.length-1, count = 0; count<k; i--, count++ ){
  ...
  public static int [] rotateLeft(int [] source, int k){
    ...
    for(int i=source.length-1, count = k-1; count >= 0; i--, count-- ){
  ...
  public static int [] shiftRight(int [] source, int k){
    ...
    for(int i=source.length-k-1; i>=0; i--){
  ...
  public static int [] rotateRight(int [] source, int k){
    ...
    for(int i=source.length-1, j = keep.length-1; j>=0; j--, i--){
  ...
  /** @return true if insertion is successful; @return false otherwise
    ...
    * if insertion is successful, print the 'Number of elements afxter insertion' is completed
    */
