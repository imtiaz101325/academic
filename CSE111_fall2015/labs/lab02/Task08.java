...
//Lab 2
//Task 8:
//Write a java program that reads 10 numbers from the user, but does not allow the user 
//    to enter duplicates. This means that if a number has been entered already, the program 
//    will not accept it as input again and instead ask the user to enter a different number.
